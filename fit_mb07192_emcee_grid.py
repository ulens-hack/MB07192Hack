...
grid_parameters = read.read_grid_parameters(config)
...
qs = np.arange(grid_parameters['logq_min'], grid_parameters['logq_max'], grid_parameters['dlogq']) 
ss = np.arange(grid_parameters['logs_min'], grid_parameters['logs_max'], grid_parameters['dlogs']) 
