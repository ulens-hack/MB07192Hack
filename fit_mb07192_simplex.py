...
import configparser
import scipy.optimize as op #Nelder-Mead
...
fixed_parameters = read.read_fix_parameters(config)   #Grid parameters
#grid_parameters = read.read_grid_parameters(config)   #Grid parameters
...
#define chi2_for_model #nelder-mead
